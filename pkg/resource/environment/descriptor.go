...
const (
	FinalizerString = "finalizers.mwaa.services.k8s.aws/Environment"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("environments")
	GroupKind            = metav1.GroupKind{
		Group: "mwaa.services.k8s.aws",
		Kind:  "Environment",
	}
)
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.Environment),
	}
}
